        ...
        return (
            <div className="App">
                <Router>
                    <Fragment>
                        <ToastContainer/>
                        <NavBar username={this.state.username} isAdmin={this.state.isAdmin} logoutUser={this.logoutUser}/>
                        <Switch>
                            <Route path="/" render={() => <Home movies={this.state.movies} username={this.state.username}/>} exact/>
                            <Route path="/user" render={(props) => this.state.username
                                ? <Redirect to="/"/>
                                : <User {...props} registerUser={this.registerUser} loginUser={this.loginUser}/>
                            }/>
                            <Route path="/create" render={() => this.state.isAdmin
