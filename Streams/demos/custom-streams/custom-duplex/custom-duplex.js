...
duplex.write(Buffer.from('test string 0\n'));
duplex.write(Buffer.from('test string 1\n'));
duplex.write(Buffer.from('test string 2'));
duplex.write(Buffer.from('test string 3'));
