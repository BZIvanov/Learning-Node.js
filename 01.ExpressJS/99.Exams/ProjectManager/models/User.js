...
const userSchema = new mongoose.Schema({
    ...
    firstName: { type: mongoose.Schema.Types.String, required: [true, 'Please add First name'] },
    lastName: { type: mongoose.Schema.Types.String, required: [true, 'Please add Last name'] },
