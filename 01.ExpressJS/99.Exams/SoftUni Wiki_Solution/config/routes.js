...
module.exports = (app) => {
  ...
  app.get(
    ...
    controllers.article.createGet
  );
  app.post(
    '/article/create',
    restrictedPages.isAuthed,
    controllers.article.createPost
  );
  ...
  app.get(
    '/article/edit/:id',
    restrictedPages.isAuthed,
    controllers.article.editGet
  );
  app.post(
    '/article/edit/:id',
    restrictedPages.isAuthed,
    controllers.article.editPost
  );
  app.get(
    '/article/history/:id',
    restrictedPages.isAuthed,
    controllers.article.getHistory
  );
  app.get('/article/latest', controllers.article.getLatest);
  app.get(
    '/edit/details/:id',
    restrictedPages.isAuthed,
    controllers.article.showEditDetails
  );
  ...
  app.get(
    ...
    controllers.article.lock
  );
  app.get(
    '/article/unlock/:id',
    restrictedPages.hasRole('Admin'),
    controllers.article.unlock
  );
